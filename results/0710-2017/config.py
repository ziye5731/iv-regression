...
# 1. Model
# ============================================================================
MODEL = "quadratic"                 # "linear", "quadratic", "poly2", "poly3"
...
# 5. Training
# ============================================================================
N_ITERATIONS = 100000           # iterations per run (same for all algorithms)
...
DCOV_B = 32                     # batch size for distance covariance estimate
